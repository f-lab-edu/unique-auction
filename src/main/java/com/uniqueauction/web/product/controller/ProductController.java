...
public class ProductController {
	...
	@PostMapping("/products/temp")
	@ResponseStatus(HttpStatus.CREATED)
	public CommonResponse incrementPrice(@RequestBody @Validated ProductUpdateRequest productUpdateRequest,
										 @RequestParam int price,
										 BindingResult result) {

		Product product = productService.incrementPrice(productUpdateRequest.toEntity(), price);
